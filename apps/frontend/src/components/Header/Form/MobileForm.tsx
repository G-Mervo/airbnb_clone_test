...
// Day 1: MobileFormModal removed; keep static pill only
...
const MobileForm = () => {
  ...
  const handleMobileFormClick = () => {
    // Day 1: static pill only, no modal open
    return;
  };
    ...
    <div className="flex space-x-2 items-center px-2">
      ...
      <div className="flex flex-col">
        <div className="flex items-center">
          <img src={houseIcon} alt="House" className="w-4 h-4 mr-2" />
...
const DefaultView = (_props?: { displaySearch?: string; displaySearchWeek?: string; displayGuestInput?: string }) => (
  <>
    <SearchSVG />
    <div className="flex flex-col">
      ...
      <div className="flex items-center space-x-1">
        <div className="flex items-center">
          <img src={houseIcon} alt="House" className="w-3 h-3 mr-1" />
