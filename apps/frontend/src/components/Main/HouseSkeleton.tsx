...
const ShimmerBlock = ({ width, height, marginBottom }: { width: string; height: string; marginBottom?: string }) => (
  <div
    className={`w-[${width}] h-${height} animate-shimmer bg-gray-200 ${marginBottom ? `mb-${marginBottom}` : ""}`}
  ></div>
);
